...
Thread::Fork(VoidFunctionPtr func, void *arg)
{
    ...
    scheduler->ReadyToRun(this);	// ReadyToRun assumes that interrupts
					// are disabled!
    start_aging_tick = kernel->stats->totalTicks;
...
Thread::Sleep (bool finishing)
{
    ...
    DEBUG('z', "[D] Tick [" << kernel->stats->totalTicks << "]: Thread [" << this->getID() << "] update approximate burst time, from: [" << old_predicted_burst_time << "], add [" << real_burst_time <<"], to [" << predicted_burst_time <<"]");
